...
const WalletBox = ({item , index, wallets, setWallets, toast, showKey, setShowKey}) => {
  return (
    <div key={item.path} className="border rounded-lg p-5">
                  ...
                  <div className="bg-[#a1a1aa50] rounded-md mt-5 my-2 p-4 flex flex-col gap-5">
                    <div>
                      ...
                      <h3 className="text-xs md:text-lg">{item.publicKey}</h3>
                    </div>
                    ...
                    <div>
                      <h3
                        ...
                        onClick={() => {
                          ...
                          toast({
                            title: "Copied",
                            description:
                              "Your secret private key copied to clipboard.",
                          });
                        }}
                      >
                        Private Key
                      ...
                      <div className="flex">
                        <input
                          type={
                            showKey.includes(item.path) ? "text" : "password"
                          }
                        ...
                        {showKey.includes(item.path) ? (
                          ...
                          <EyeOff
                            onClick={() =>
                              setShowKey((prev) => [...prev, item.path])
                            }
                            className="cursor-pointer transition-all"
                          />
                        )}
